...
<svg xmlns="http://www.w3.org/2000/svg" width="18.642" height="20" viewBox="0 0 18.642 20">
    <defs>
        <style>
        </style>
    </defs>
...
export const SearchIcon = props =>(
    ...
    <g id="prefix__search_1_" data-name="search (1)" transform="translate(4.95)">
        <path id="prefix__Path_4" fill="#fff" d="M29.784 28.47l-7.29-7.29a12.8 12.8 0 1 0-1.264 1.264l7.29 7.29a.9.9 0 0 0 .632.266.876.876 0 0 0 .632-.266.9.9 0 0 0 0-1.264zM1.839 12.792a11 11 0 1 1 11 11 11.008 11.008 0 0 1-11-11z" data-name="Path 4" transform="translate(-5)"/>
    </g>
</svg>
...
export const FacebookIcon = props =>(
    ...
    <path id="prefix__facebook" fill="#fff" d="M8.914 24H5.071a1.165 1.165 0 0 1-1.164-1.164v-8.669H1.664A1.166 1.166 0 0 1 .5 13V9.288a1.165 1.165 0 0 1 1.164-1.164h2.243V6.263a6.334 6.334 0 0 1 1.674-4.537A6.032 6.032 0 0 1 10.029 0h2.931a1.166 1.166 0 0 1 1.162 1.164v3.454a1.165 1.165 0 0 1-1.164 1.164h-1.973c-.6 0-.755.121-.788.158-.054.061-.118.235-.118.714v1.47h2.731a1.183 1.183 0 0 1 .576.146 1.168 1.168 0 0 1 .6 1.018V13a1.165 1.165 0 0 1-1.164 1.164h-2.743v8.669A1.166 1.166 0 0 1 8.914 24zm-3.6-1.407h3.357v-9.056a.778.778 0 0 1 .777-.777h3.128V9.531H9.449a.778.778 0 0 1-.777-.777v-2.1a2.4 2.4 0 0 1 .471-1.645 2.385 2.385 0 0 1 1.842-.634h1.731V1.411h-2.687c-2.907 0-4.714 1.861-4.714 4.857v2.49a.778.778 0 0 1-.777.777H1.907v3.225h2.63a.778.778 0 0 1 .777.777zm7.643-21.182zm0 0" transform="translate(-.5)"/>
</svg>
...
export const TickIcon = props =>(
    <svg xmlns="http://www.w3.org/2000/svg" id="prefix__tick" width="30" height="30" viewBox="0 0 30 30">
    <defs>
        <style>
        </style>
    </defs>
    <g id="prefix__Group_58" data-name="Group 58" transform="translate(7.123 3.769)">
        <g id="prefix__Group_57" data-name="Group 57">
            <path id="prefix__Path_29" d="M143.587 64.659a1.13 1.13 0 0 0-1.6 0l-13.563 13.527-4.894-5.315a1.131 1.131 0 0 0-1.664 1.532l5.691 6.181a1.129 1.129 0 0 0 .808.364h.024a1.132 1.132 0 0 0 .8-.33l14.4-14.359a1.13 1.13 0 0 0-.002-1.6z" class="prefix__cls-1" data-name="Path 29" transform="translate(-121.568 -64.327)"/>
        </g>
    </g>
    <g id="prefix__Group_60" data-name="Group 60">
        <g id="prefix__Group_59" data-name="Group 59">
            <path id="prefix__Path_30" d="M28.869 13.869A1.131 1.131 0 0 0 27.739 15 12.739 12.739 0 1 1 15 2.261 1.131 1.131 0 1 0 15 0a15 15 0 1 0 15 15 1.131 1.131 0 0 0-1.131-1.131z" class="prefix__cls-1" data-name="Path 30"/>
        </g>
    </g>
</svg>
...
export const SignsIcon = props =>(
<svg xmlns="http://www.w3.org/2000/svg" width="25" height="25.049" viewBox="0 0 25 25.049">
    <path id="prefix__signs" fill="#22aea5" d="M5.86 10.01a4.155 4.155 0 0 0 4.15 4.15.977.977 0 1 1 0 1.953 6.1 6.1 0 1 1 6.1-6.1.977.977 0 0 1-1.953 0 4.15 4.15 0 1 0-8.3 0zm.767 8.638C4.121 15.9 1.957 13.534 1.953 10a8.057 8.057 0 0 1 16.113 0 .976.976 0 0 0 .977.975.976.976 0 0 0 .977-.975A10.01 10.01 0 0 0 2.936 2.928 9.946 9.946 0 0 0 0 10a10.458 10.458 0 0 0 1.653 5.582 29.717 29.717 0 0 0 3.532 4.382 33.339 33.339 0 0 1 3.707 4.581.977.977 0 1 0 1.651-1.045 34.845 34.845 0 0 0-3.916-4.854zm18.117.469a.977.977 0 0 1-1.38.062l-.122-.112V22.3a2.753 2.753 0 0 1-2.749 2.751h-5.488a2.753 2.753 0 0 1-2.749-2.751v-3.189l-.073.067a.977.977 0 1 1-1.318-1.442l5.04-4.608a2.755 2.755 0 0 1 3.737 0l3.23 2.953a.978.978 0 0 1 .1.092l1.71 1.564a.976.976 0 0 1 .062 1.38zm-3.455-1.836l-2.965-2.711a.812.812 0 0 0-1.1 0l-3.014 2.755V22.3a.8.8 0 0 0 .8.8h5.488a.8.8 0 0 0 .8-.8zm0 0"/>
</svg>
...
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
    ...
    <g id="prefix__logo" transform="translate(0 -.001)">
        <path id="prefix__Path_22" d="M12 5.838A6.158 6.158 0 1 0 18.162 12 6.157 6.157 0 0 0 12 5.838zm0 10.155a4 4 0 1 1 4-4 4 4 0 0 1-4 4z" class="prefix__cls-1" data-name="Path 22"/>
        <path id="prefix__Path_23" d="M16.948.076c-2.208-.1-7.677-.1-9.887 0a7.172 7.172 0 0 0-5.036 1.941C-.283 4.325.012 7.435.012 12c0 4.668-.26 7.706 2.013 9.979C4.342 24.291 7.5 23.988 12 23.988c4.624 0 6.22 0 7.855-.63 2.223-.863 3.9-2.85 4.065-6.419.1-2.209.1-7.677 0-9.887-.2-4.213-2.459-6.768-6.976-6.976zm3.5 20.372c-1.513 1.513-3.612 1.378-8.468 1.378-5 0-7.005.074-8.468-1.393-1.685-1.677-1.38-4.37-1.38-8.453 0-5.525-.567-9.5 4.978-9.788 1.274-.045 1.649-.06 4.856-.06l.045.03c5.329 0 9.51-.558 9.761 4.986.057 1.265.07 1.645.07 4.847 0 4.942.093 6.959-1.394 8.453z" class="prefix__cls-1" data-name="Path 23"/>
        <circle id="prefix__Ellipse_6" cx="1.439" cy="1.439" r="1.439" class="prefix__cls-1" data-name="Ellipse 6" transform="translate(16.967 4.156)"/>
    </g>
</svg>
